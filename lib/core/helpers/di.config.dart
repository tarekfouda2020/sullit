...
import 'package:flutter_tdd/core/helpers/rate_app_helper.dart' as _i77;
import 'package:flutter_tdd/core/helpers/utilities.dart' as _i90;
...
import 'package:flutter_tdd/core/http/dio_helper/actions/post.dart' as _i62;
import 'package:flutter_tdd/core/http/dio_helper/actions/put.dart' as _i76;
...
extension GetItInjectableX on _i1.GetIt {
  ...
  _i1.GetIt init({
    ...
    gh.factory<_i58.PaymentDataSources>(() => _i59.PaymentDataSourcesImpl());
    gh.factory<_i60.PaymentRepository>(() => _i61.PaymentRepositoryImpl());
    gh.lazySingleton<_i62.Post>(() => _i62.Post());
    gh.factory<_i63.ProductsDataSource>(() => _i64.ImplProductsDataSource());
    gh.factory<_i65.ProductsHelper>(() => _i65.ProductsHelper());
    gh.factory<_i66.ProductsRepository>(() => _i67.ImplProductsRepository());
    gh.factory<_i68.ProfileDataSources>(() => _i69.ImplProfileDataSources());
    gh.factory<_i70.ProfileRepository>(() => _i71.ImplProfileRepository());
    gh.factory<_i72.PurchasingDataSources>(
        () => _i73.ImplPurchasingDataSources());
    gh.factory<_i74.PurchasingRepository>(
        () => _i75.ImplPurchasingRepository());
    gh.lazySingleton<_i76.Put>(() => _i76.Put());
    gh.lazySingleton<_i77.RateAppHelper>(() => _i77.RateAppHelper());
    gh.factory<_i78.SaleDataSources>(() => _i79.ImplSaleRepository());
    gh.factory<_i80.SaleRepository>(() => _i81.ImplSaleRepository());
    gh.factory<_i82.SearchDataSources>(() => _i83.ImplSearchDataSources());
    gh.factory<_i84.SearchRepository>(() => _i85.ImplSearchRepository());
    gh.factory<_i86.TicketsDataSources>(() => _i87.ImplTicketsDataSources());
    gh.factory<_i88.TicketsRepository>(() => _i89.ImplTicketsRepository());
    gh.lazySingleton<_i90.Utilities>(() => _i90.Utilities());
    gh.factory<_i91.WalletDataSources>(() => _i92.ImplWalletDataSources());
    gh.factory<_i93.WalletRepository>(() => _i94.ImplWalletRepository());
    gh.factory<_i95.WishlistDataSources>(() => _i96.ImplWishlistDataSources());
    gh.factory<_i97.WishlistRepository>(() => _i98.ImplWishlistRepository());
    return this;
  }
}

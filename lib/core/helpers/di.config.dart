...
import 'package:flutter_tdd/core/helpers/firebase_analytics_helper.dart'
    as _i51;
import 'package:flutter_tdd/core/helpers/get_device_id.dart' as _i54;
import 'package:flutter_tdd/core/helpers/global_context.dart' as _i59;
import 'package:flutter_tdd/core/helpers/global_notification.dart' as _i60;
import 'package:flutter_tdd/core/helpers/loading_helper.dart' as _i64;
import 'package:flutter_tdd/core/helpers/location_service.dart' as _i65;
import 'package:flutter_tdd/core/helpers/new_version_helper.dart' as _i71;
import 'package:flutter_tdd/core/helpers/psermission_services.dart' as _i81;
import 'package:flutter_tdd/core/helpers/rate_app_helper.dart' as _i97;
import 'package:flutter_tdd/core/helpers/user_service_helper.dart' as _i110;
import 'package:flutter_tdd/core/helpers/utilities.dart' as _i111;
import 'package:flutter_tdd/core/http/dio_helper/actions/delete.dart' as _i47;
import 'package:flutter_tdd/core/http/dio_helper/actions/download.dart' as _i50;
import 'package:flutter_tdd/core/http/dio_helper/actions/get.dart' as _i53;
import 'package:flutter_tdd/core/http/dio_helper/actions/patch.dart' as _i76;
import 'package:flutter_tdd/core/http/dio_helper/actions/post.dart' as _i82;
import 'package:flutter_tdd/core/http/dio_helper/actions/put.dart' as _i96;
import 'package:flutter_tdd/core/http/dio_helper/utils/dio_header.dart' as _i48;
...
import 'package:flutter_tdd/core/http/dio_helper/utils/handle_request_body.dart'
    as _i63;
import 'package:flutter_tdd/core/http/generic_http/generic_http.dart' as _i52;
import 'package:flutter_tdd/core/network/network_info.dart' as _i70;
...
extension GetItInjectableX on _i1.GetIt {
  ...
  _i1.GetIt init({
    ...
    gh.factory<_i24.CartHelper>(() => _i24.CartHelper());
    gh.factory<_i25.CartRepository>(() => _i26.ImplCartRepository());
    gh.factory<_i27.CategoryDataSources>(() => _i28.ImplCategoryDataSources());
    gh.factory<_i29.CategoryRepository>(() => _i30.ImplCategoryRepository());
    gh.factory<_i31.ClassifiedProductsDataSources>(
        () => _i32.ImplClassifiedProductsDataSources());
    gh.factory<_i33.ClassifiedProductsRepository>(
        () => _i34.ImplClassifiedProductsRepository());
    gh.factory<_i35.CommonDataSources>(() => _i36.ImplCommonDataSources());
    gh.factory<_i37.CommonRepository>(() => _i38.ImplCommonRepository());
    gh.factory<_i39.CusProductRepository>(
        () => _i40.ImplCusProductsRepository());
    gh.factory<_i41.CusProductsDataSources>(
        () => _i42.ImplCusProductsDataSources());
    gh.factory<_i43.DashboardDataSources>(
        () => _i44.ImplDashboardDataSources());
    gh.factory<_i45.DashboardRepository>(() => _i46.ImplDashboardRepository());
    gh.lazySingleton<_i47.Delete>(() => _i47.Delete());
    gh.lazySingleton<_i48.DioHeader>(() => _i48.DioHeader());
    gh.lazySingleton<_i49.DioOptions>(() => _i49.DioOptions());
    gh.lazySingleton<_i50.Download>(() => _i50.Download());
    gh.lazySingleton<_i51.FirebaseAnalyticsHelper>(
        () => _i51.FirebaseAnalyticsHelper());
    gh.lazySingleton<_i52.GenericHttpImpl<dynamic>>(
        () => _i52.GenericHttpImpl<dynamic>());
    gh.lazySingleton<_i53.Get>(() => _i53.Get());
    gh.factory<_i54.GetDeviceId>(() => _i54.GetDeviceId());
    gh.factory<_i55.GiftCardsDataSource>(() => _i56.ImplGiftCardDataSource());
    gh.factory<_i57.GiftCardsRepositories>(
        () => _i58.ImplGiftCardRepositories());
    gh.lazySingleton<_i59.GlobalContext>(() => _i59.GlobalContext());
    gh.lazySingleton<_i60.GlobalNotification>(() => _i60.GlobalNotification());
    gh.lazySingleton<_i61.HandleErrors>(() => _i61.HandleErrors());
    gh.lazySingleton<_i62.HandleJsonResponse<dynamic>>(
        () => _i62.HandleJsonResponse<dynamic>());
    gh.lazySingleton<_i63.HandleRequestBody>(() => _i63.HandleRequestBody());
    gh.lazySingleton<_i64.LoadingHelper>(() => _i64.LoadingHelper());
    gh.factory<_i65.LocationService>(() => _i65.LocationService());
    gh.factory<_i66.LoyaltyPointsDataSource>(
        () => _i67.ImplLoyaltyPointsDataSource());
    gh.factory<_i68.LoyaltyPointsRepository>(
        () => _i69.ImplLoyaltyPointsRepository());
    gh.lazySingleton<_i70.NetworkInfoImpl>(() => _i70.NetworkInfoImpl());
    gh.lazySingleton<_i71.NewVersionHelper>(() => _i71.NewVersionHelper());
    gh.factory<_i72.NotificationsDataSources>(
        () => _i73.ImplNotificationsDataSources());
    gh.factory<_i74.NotificationsRepository>(
        () => _i75.ImplNotificationsRepository());
    gh.lazySingleton<_i76.Patch>(() => _i76.Patch());
    gh.factory<_i77.PaymentDataSources>(() => _i78.PaymentDataSourcesImpl());
    gh.factory<_i79.PaymentRepository>(() => _i80.PaymentRepositoryImpl());
    gh.factory<_i81.PermissionServices>(() => _i81.PermissionServices());
    gh.lazySingleton<_i82.Post>(() => _i82.Post());
    gh.factory<_i83.ProductsDataSource>(() => _i84.ImplProductsDataSource());
    gh.factory<_i85.ProductsHelper>(() => _i85.ProductsHelper());
    gh.factory<_i86.ProductsRepository>(() => _i87.ImplProductsRepository());
    gh.factory<_i88.ProfileDataSources>(() => _i89.ImplProfileDataSources());
    gh.factory<_i90.ProfileRepository>(() => _i91.ImplProfileRepository());
    gh.factory<_i92.PurchasingDataSources>(
        () => _i93.ImplPurchasingDataSources());
    gh.factory<_i94.PurchasingRepository>(
        () => _i95.ImplPurchasingRepository());
    gh.lazySingleton<_i96.Put>(() => _i96.Put());
    gh.lazySingleton<_i97.RateAppHelper>(() => _i97.RateAppHelper());
    gh.factory<_i98.SaleDataSources>(() => _i99.ImplSaleRepository());
    gh.factory<_i100.SaleRepository>(() => _i101.ImplSaleRepository());
    gh.factory<_i102.SearchDataSources>(() => _i103.ImplSearchDataSources());
    gh.factory<_i104.SearchRepository>(() => _i105.ImplSearchRepository());
    gh.factory<_i106.TicketsDataSources>(() => _i107.ImplTicketsDataSources());
    gh.factory<_i108.TicketsRepository>(() => _i109.ImplTicketsRepository());
    gh.lazySingleton<_i110.UserServiceHelper>(() => _i110.UserServiceHelper());
    gh.lazySingleton<_i111.Utilities>(() => _i111.Utilities());
    gh.factory<_i112.VipDataSource>(() => _i113.ImplVipSubscribeDataSource());
    gh.factory<_i114.VipRepositories>(() => _i115.ImplVipSubscribe());
    gh.factory<_i116.WalletDataSources>(() => _i117.ImplWalletDataSources());
    gh.factory<_i118.WalletRepository>(() => _i119.ImplWalletRepository());
    gh.factory<_i120.WishlistDataSources>(
        () => _i121.ImplWishlistDataSources());
    gh.factory<_i122.WishlistRepository>(() => _i123.ImplWishlistRepository());
    return this;
  }
}

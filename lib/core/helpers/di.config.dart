...
import 'package:flutter_tdd/core/http/dio_helper/actions/patch.dart' as _i75;
import 'package:flutter_tdd/core/http/dio_helper/actions/post.dart' as _i81;
import 'package:flutter_tdd/core/http/dio_helper/actions/put.dart' as _i95;
...
import 'package:flutter_tdd/core/network/network_info.dart' as _i69;
...
extension GetItInjectableX on _i1.GetIt {
  ...
  _i1.GetIt init({
    ...
    gh.factory<_i65.LoyaltyPointsDataSource>(
        () => _i66.ImplLoyaltyPointsDataSource());
    gh.factory<_i67.LoyaltyPointsRepository>(
        () => _i68.ImplLoyaltyPointsRepository());
    gh.lazySingleton<_i69.NetworkInfoImpl>(() => _i69.NetworkInfoImpl());
    gh.lazySingleton<_i70.NewVersionHelper>(() => _i70.NewVersionHelper());
    gh.factory<_i71.NotificationsDataSources>(
        () => _i72.ImplNotificationsDataSources());
    gh.factory<_i73.NotificationsRepository>(
        () => _i74.ImplNotificationsRepository());
    gh.lazySingleton<_i75.Patch>(() => _i75.Patch());
    gh.factory<_i76.PaymentDataSources>(() => _i77.PaymentDataSourcesImpl());
    gh.factory<_i78.PaymentRepository>(() => _i79.PaymentRepositoryImpl());
    gh.factory<_i80.PermissionServices>(() => _i80.PermissionServices());
    gh.lazySingleton<_i81.Post>(() => _i81.Post());
    gh.factory<_i82.ProductsDataSource>(() => _i83.ImplProductsDataSource());
    gh.factory<_i84.ProductsHelper>(() => _i84.ProductsHelper());
    gh.factory<_i85.ProductsRepository>(() => _i86.ImplProductsRepository());
    gh.factory<_i87.ProfileDataSources>(() => _i88.ImplProfileDataSources());
    gh.factory<_i89.ProfileRepository>(() => _i90.ImplProfileRepository());
    gh.factory<_i91.PurchasingDataSources>(
        () => _i92.ImplPurchasingDataSources());
    gh.factory<_i93.PurchasingRepository>(
        () => _i94.ImplPurchasingRepository());
    gh.lazySingleton<_i95.Put>(() => _i95.Put());
    gh.lazySingleton<_i96.RateAppHelper>(() => _i96.RateAppHelper());
    gh.factory<_i97.SaleDataSources>(() => _i98.ImplSaleRepository());
    gh.factory<_i99.SaleRepository>(() => _i100.ImplSaleRepository());
    gh.factory<_i101.SearchDataSources>(() => _i102.ImplSearchDataSources());

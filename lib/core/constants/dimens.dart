...
class Dimens {
  ...
  static double iosBottomDp(BuildContext context) =>
      Platform.isIOS ? MediaQuery.paddingOf(context).bottom + 13 : 16;
  ...
  static BorderRadius borderRadius15PX =
  ...
  static EdgeInsets paddingH10V10 =
      const EdgeInsets.symmetric(horizontal: dp10, vertical: dp10).r;
  ...
  static EdgeInsets paddingH20V15 =
      const EdgeInsets.symmetric(horizontal: dp20, vertical: dp15).r;
  static EdgeInsets paddingH20V25 =
      const EdgeInsets.symmetric(horizontal: dp20, vertical: dp25).r;
  static EdgeInsets paddingH35V26 =
      const EdgeInsets.symmetric(horizontal: dp35, vertical: dp26).r;
  ...
  static EdgeInsets paddingH12V16 =
      const EdgeInsets.symmetric(horizontal: dp12, vertical: dp16).r;
  static EdgeInsets paddingH32V16 =
  ...
  static EdgeInsets paddingVertical10PXHorizontal20PX =
  ...
  static EdgeInsets paddingVertical12PX =
  ...
  static EdgeInsets paddingVertical36PX =
      const EdgeInsets.symmetric(vertical: 36).r;
  ...
  static EdgeInsets paddingHorizontal12PX =
  ...
  static EdgeInsetsDirectional paddingStart20 =
      EdgeInsetsDirectional.only(start: 20.r);
  static EdgeInsetsDirectional paddingStart19 =
      EdgeInsetsDirectional.only(start: 19.r);
  static EdgeInsetsDirectional paddingEnd19 =
      const EdgeInsetsDirectional.only(end: 19);
  static EdgeInsetsDirectional paddingEnd10 =
      const EdgeInsetsDirectional.only(end: 10);

  static EdgeInsetsDirectional paddingS22T10B10 =
      const EdgeInsetsDirectional.only(start: 22, top: 10, bottom: 10);
  ...
  static EdgeInsets marginVertical18 =
      const EdgeInsets.symmetric(vertical: 18).r;
  static EdgeInsets marginVertical20 =
      const EdgeInsets.symmetric(vertical: 20).r;

  static EdgeInsets marginTop8Bottom20 =
      const EdgeInsets.only(top: 8, bottom: 20).r;
  static EdgeInsets marginTop5Bottom12 =
      const EdgeInsets.only(top: 5, bottom: 12).r;

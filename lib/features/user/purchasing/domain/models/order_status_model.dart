...
TrackOrderEnum getStatusType(){
  switch(status){
    ...
    case "Confirmed" : return TrackOrderEnum.confirmed;
    case "Picked Up" : return TrackOrderEnum.pickedUp;
    case "On The Way" : return TrackOrderEnum.onTheWay;
    case "Delivered" : return TrackOrderEnum.delivered;
    case "Cancelled" : return TrackOrderEnum.cancelled;

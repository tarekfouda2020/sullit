...
import '../restaurant_cart_imports.dart';

part 'restaurant_info_widget.dart';
part 'restaurant_cart_items_widget.dart';
part 'build_restaurant_cart_item.dart';
part 'change_restaurant_cart_qty_widget.dart';
part 'restaurant_cart_fav_icon_widget.dart';
part 'build_custom_bounce.dart';
part 'restaurant_bottom_nav_widget.dart';
part 'build_restaurant_cart_loading.dart';

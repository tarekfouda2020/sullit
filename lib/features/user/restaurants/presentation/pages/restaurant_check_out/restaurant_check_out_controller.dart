...
class RestaurantCheckOutController {
  ...
  RestaurantCheckOutController(Shipping? shipping, this.checkoutParams, this.confirmOrderId, {this.fromOrderDetails = false}) {
    initData(shipping);
  ...
  Future<void> submitConfirmOrder(BuildContext ctx) async {
    ...
    if (data != null) {
      if (data.transactionUrl != null) {
        ...
        _onRestaurantOrderConfirmed(ctx, data);
      }
    }
  }
  ...
  void _onRestaurantOrderConfirmed(BuildContext context, PharmacyConfirmOrderDomainModel data) {
  ...
  void _confirmOrder(BuildContext context,OrderSummaryDomainModel data) {
    ...
    AutoRouter.of(context).push( RestaurantOrderSuccessRoute(summary: data));
  }
  ...
  RestaurantCreateOrderParams _orderParams() {
    return RestaurantCreateOrderParams(
      paymentOption: paymentOptionsBloc.state.data
          .firstWhere((element) => element.selected)
          .paymentTypeKey,
  ...
  void paymentMethodSheet(BuildContext context) {
    showModalBottomSheet(
      ...
      enableDrag: false,
      builder: (context) => RestaurantPaymentMethodBottomSheetWidget(controller: this),
    );
  }
  ...
  void giftCardSheet(BuildContext context) {
    showModalBottomSheet(
      ...
      useRootNavigator: true,
      enableDrag: false,
      builder: (context) => RestaurantApplyGiftCardSheet(controller: this),
    );
  }
  ...
  Future<void> showReplacementAlertSheet(BuildContext context) async {
    await showModalBottomSheet(
      ...
      useRootNavigator: true,
      builder: (context) {
        return RestaurantRequestReplaceSheetWidget(controller: this);
      },
    );
  }

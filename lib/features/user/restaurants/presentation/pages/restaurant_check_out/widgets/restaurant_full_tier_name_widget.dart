...
class RestaurantFullTierNameWidget extends StatelessWidget {
  final String description;
  final String title;
  const RestaurantFullTierNameWidget(
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
          borderRadius: Dimens.sheetBorderRadius, color: context.colors.white),
      child: Column(

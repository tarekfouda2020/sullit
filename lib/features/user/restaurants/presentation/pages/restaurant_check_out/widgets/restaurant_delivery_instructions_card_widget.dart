...
class RestaurantDeliveryInstructionsCardWidget extends StatelessWidget {
  final RestaurantCheckOutController controller;

  const RestaurantDeliveryInstructionsCardWidget({super.key, required this.controller});
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: Row(
                        ...
                        children: List.generate(
                          state.data.length,
                          (index) {
                            return RestaurantInstructionItemWidget(

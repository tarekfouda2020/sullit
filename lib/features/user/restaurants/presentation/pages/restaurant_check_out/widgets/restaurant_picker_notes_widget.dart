...
class RestaurantPickerNotesWidget extends StatelessWidget {
  final RestaurantCheckOutController controller;
  const RestaurantPickerNotesWidget({super.key, required this.controller});
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        Row(
          children: [
            const RestaurantCartPaymentSectionTitleWidget(title: "picker instructions"),
            Text(
              tr("optional"),

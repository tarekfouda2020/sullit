...
class RestaurantOrderSuccessController {
  ...
  final ShopCardDomainModel? restaurantData;

  Orders? get firstSectionOrder =>
      orderSummaryBloc.state.data?.sectionOrders?.firstOrNull;

  ShopCardDomainModel? get restaurant => restaurantData ?? firstSectionOrder?.shop;

  RestaurantOrderSuccessController(this.summary, this.restaurantData) {

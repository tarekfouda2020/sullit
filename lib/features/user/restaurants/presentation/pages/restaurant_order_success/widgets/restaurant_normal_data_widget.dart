...
class RestaurantNormalDataWidget extends StatelessWidget {
  final OrderSummaryDomainModel data;
  const RestaurantNormalDataWidget({super.key, required this.data});
        ...
        RichText(
          ...
          text: TextSpan(
            children: [
              ...
              TextSpan(
                text: " accepted your Restaurant document successfully",

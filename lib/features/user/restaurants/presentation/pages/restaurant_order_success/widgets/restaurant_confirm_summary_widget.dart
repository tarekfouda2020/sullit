...
class RestaurantConfirmSummaryWidget extends StatelessWidget {
  final OrderSummaryDomainModel orderSummary;
  final RestaurantOrderSuccessController controller;
  const RestaurantConfirmSummaryWidget({super.key, required this.orderSummary, required this.controller});

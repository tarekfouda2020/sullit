...
class ApplyGiftCard extends UseCase<GiftCardApllieCartDomainModel?, ApplyGiftCardParams>{
  @override
  Future<GiftCardApllieCartDomainModel?> call(ApplyGiftCardParams params)async {

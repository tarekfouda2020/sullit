...
class GetClassifiedProducts implements UseCase<ClassifiedProductsDomainModel?, bool> {
  @override
  Future<ClassifiedProductsDomainModel?> call(bool param) async {
    var result = await getIt<ClassifiedProductsRepository>().getClassifiedProducts(param);
    return result.fold(
      (l) => null,
      (r) => r,
    );

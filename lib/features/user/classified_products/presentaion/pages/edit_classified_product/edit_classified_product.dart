          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                InkWell(
                  onTap: () => controller.showImageDialog(context, FileImageType.multiImage,ImageType.generalImages),
                  child: Container(
                    height: 60,
                    width: 60,
                    decoration: CustomDecoration(),
                ...
                InkWell(
                  onTap: () => controller.showImageDialog(context, FileImageType.singleImage,ImageType.thumbnail),
                  child: Container(
                    height: 60,
                    width: 60,
                    decoration: CustomDecoration(),
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                InkWell(
                  onTap: () => controller.showImageDialog(context, FileImageType.singleImage, ImageType.meta),
                  child: Container(
                    height: 60,
                    width: 60,
                    decoration: CustomDecoration(),

...
class GetGiftCardSubscriptionsDetails implements UseCase<GiftCardDomainModel?, int> {

  @override
  Future<GiftCardDomainModel?> call(int param) async {
    var result = await getIt.get<GiftCardsRepositories>().giftCardSubscriptionDetails(param);
    return result.fold(
          (l) => null,
          (r) => r,
    );

...
class GetUserGiftCards implements UseCase<List<GiftCardDomainModel>, GenericPaginateParams> {

  @override
  Future<List<GiftCardDomainModel>> call(GenericPaginateParams param) async {
    var result = await getIt.get<GiftCardsRepositories>().giftCardSubscriptionsList(param);
    return result.fold(
          (l) => [],
          (r) => r,
    );

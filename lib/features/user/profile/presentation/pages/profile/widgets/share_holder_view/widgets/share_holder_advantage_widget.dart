...
class ShareHolderAdvantageWidget extends StatelessWidget {
        ...
        BlocBuilder<GenericBloc<bool>, GenericState<bool>>(
          ...
          builder: (context, isExpand) {
            return Container(
              ...
              height: isExpand.data ? null : 240,
              padding: const EdgeInsets.symmetric(horizontal: 20, vertical: 15),
              decoration: BoxDecoration(
                  color: context.colors.white.withAlpha(80),
                  borderRadius: Dimens.borderRadius12PX,
                  border: Border.all(color: const Color(0xff9C5902))),
              child: BlocBuilder<GenericBloc<VipCurrentPlanDomainModel?>,
                  GenericState<VipCurrentPlanDomainModel?>>(
                      ...
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            GestureDetector(
                              onTap: () =>
                                  controller.showTierDescription(context),
                              child: Text(
                                tr("seeAll"),
                                style: const AppTextStyle.s15_w500(
                                    color: Color(0xff9C5902)),
                              ),
                            )
                          ],
                        )
  ...
  Html _buildHtml(GenericState<VipCurrentPlanDomainModel?> state,
      BuildContext context, String lang) {
    return Html(
      data: getIt<Utilities>()
          .cleanHtml(state.data!.currentSubscription?.description ?? ""),
      style: {
        "body": Style(

...
abstract class VipDataSource{
  ...
  Future<Either<Failure, List<VipSubscribeModel>>> getSubscriptions(GenericPaginateParams params);

  Future<Either<Failure, List<PayMethodModel>>> getPayMethods();

  Future<Either<Failure, VipCurrentPlanModel>> getCurrentSubscription(bool refresh);

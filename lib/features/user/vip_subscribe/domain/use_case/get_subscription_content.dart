...
class GetSubscriptionContent implements UseCase<SubscribeContentDomainModel?, bool> {

  @override
  Future<SubscribeContentDomainModel?> call(bool param) async {
    var result = await getIt.get<VipRepositories>().getSubscriptionContent(param);
    return result.fold(
      (l) => null,
      (r) => r,
    );

...
class BuildCustomGetImage extends StatelessWidget {
  final ImageType type ;
  final AddClassifiedProductsController controller ;
  const BuildCustomGetImage({Key? key,required this.type, required this.controller,}) : super(key: key);
    ...
    return BlocBuilder<GenericBloc<File?>, GenericState<File?>>(
      ...
      builder: (context, state) {
        if (state is GenericUpdateState) {
          ...
          return InkWell(
            onTap: () => controller.showImageDialog(context),
            child: Container(
              height: 60,
              width: 60,

...
class CreatePharmacyOrder implements UseCase<OrderSummaryDomainModel?, PharmacyCreateOrderParams> {
  @override
  Future<OrderSummaryDomainModel?> call(PharmacyCreateOrderParams params) async {
    var result = await getIt<PharmaciesRepository>().createOrder(params);
    return result.fold(
          (l) => null,
          (r) => r,
    );

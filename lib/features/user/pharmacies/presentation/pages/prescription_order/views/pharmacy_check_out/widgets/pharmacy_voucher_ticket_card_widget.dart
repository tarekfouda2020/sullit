...
class PharmacyVoucherTicketCardWidget extends StatelessWidget {
  final int index;
  final bool isLast;
  const PharmacyVoucherTicketCardWidget(
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: CustomPaint(
        painter: _PharmacyTicketPainter(context: context),
        child: Container(
          height: 60,
...
class _PharmacyTicketPainter extends CustomPainter {
  final BuildContext context;

  _PharmacyTicketPainter({required this.context});
  @override

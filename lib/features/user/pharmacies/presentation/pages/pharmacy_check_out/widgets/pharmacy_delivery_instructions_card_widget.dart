...
class PharmacyDeliveryInstructionsCardWidget extends StatelessWidget {
  final PharmacyCheckOutController controller;

  const PharmacyDeliveryInstructionsCardWidget({super.key, required this.controller});
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: Row(
                        ...
                        children: List.generate(
                          state.data.length,
                          (index) {
                            return PharmacyInstructionItemWidget(

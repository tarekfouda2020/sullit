                    ...
                    children: [
                      Row(
                        children: [
                          Expanded(
                            child: Opacity(
                              opacity: state.data.totalQnt > 0 ? 1 : 0.5,
                              child: DefaultButton(
                                height: Dimens.dp50,
                            ...
                            Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Gaps.vGap8,
                                  DirhamPrice(
                                    amount: state.data.subTotal ?? "0.0",
                                    textStyle: AppTextStyle.s18_w500(
                                        color: context.colors.primary),
                                    currencyStyle: AppTextStyle.s20_w500(
                                        color: context.colors.primary),
                                    currencyOffset: -1,
                                  ),
                                ],
                      ...
                      if (state.data.minimumStatus == false &&
                        ...
                        CartMinAmountNeededWidget(
                          ...
                          sellerName:
                              "from '${state.data.getRequiredSellerName()}'",
                        ),
                    ],
                  ),
                ),

...
class PharmacyAdvantagesWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Row(
      ...
      spacing: 10,
      children: [
        _advantageItem(context, icon: Res.medicRecipeIcon, title: "Upload Prescription", subTitle: "Upload medical prescription during checkout"),
        _advantageItem(context, icon: Res.healthShield, title: "Health Insurance", subTitle: "Connect your health insurance provider"),
        _advantageItem(context, icon: Res.pharmacyDelivery, title: "Trusted Delivery", subTitle: "Temperature-controlled, fast delivery"),
      ],
    );
  }

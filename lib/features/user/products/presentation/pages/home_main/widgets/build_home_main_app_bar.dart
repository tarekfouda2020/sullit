...
class BuildHomeMainAppBar extends StatelessWidget {
  ...
  const BuildHomeMainAppBar({Key? key, required this.controller, required this.homeMainController}) : super(key: key);
              ...
              Padding(
                ...
                child: Row(
                  children: [
                    ...
                    GestureDetector(
                      onTap: () {
                        homeMainController.showAddressBottomSheet(context);
                      },
                      child: Row(
                        children: [
                          Text(

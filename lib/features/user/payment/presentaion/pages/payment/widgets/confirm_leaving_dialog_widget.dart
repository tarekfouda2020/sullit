      ...
      contentPadding: const EdgeInsets.all(15),
       ...
       content: Column(
        ...
        children: [
          ...
          Gaps.vGap15,
          Text("You are about to leave payment gateway!",
          style: AppTextStyle.s17_w600(color: context.colors.black).copyWith(
            height: 1.3
          ),
            textAlign: TextAlign.center,
          ),
          ...
          Row(
            ...
            children: [
              Expanded(
                child: DefaultButton(title: "Stay",
                margin: EdgeInsets.zero,
                  onTap: () => controller.onPressStay(context),
                ),
              ),
              Expanded(
                child: DefaultButton(title: "Leave",
                  margin: EdgeInsets.zero,

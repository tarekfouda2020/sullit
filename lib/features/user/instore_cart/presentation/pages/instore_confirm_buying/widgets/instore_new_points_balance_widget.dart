...
class InstoreNewPointsBalanceWidget extends StatelessWidget {
  final GenericBloc<LoyaltyPointsBalanceDomainModel?> cubit;
  final int gainedPoints;
  const InstoreNewPointsBalanceWidget({super.key, required this.cubit, required this.gainedPoints});

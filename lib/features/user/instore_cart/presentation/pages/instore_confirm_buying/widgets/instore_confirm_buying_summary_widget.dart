...
class InstoreConfirmBuyingSummaryWidget extends StatelessWidget {
  final OrderSummary orderSummary;
  final InstoreConfirmBuyingController controller;
  const InstoreConfirmBuyingSummaryWidget(
    ...
    return InvoiceSummaryCard(margin: Dimens.paddingHorizontal20PX, children: [
      ...
      if (!context.isShareHolder)
        Column(
          ...
          children: [
            Gaps.line(context.colors.softGray, 15.h),
            if (orderSummary.summary!.expectedLoyaltyPoints != null)
